...
export default function Home() {
  return (
    <section className="mx-auto max-w-2xl px-4 py-10">
      <h1 className="text-3xl font-bold text-gray-900">생활 계산기 모음</h1>
      ...
      <div className="mt-8 grid gap-4 sm:grid-cols-2">
        {calculators.map((c) => (
          ...
          >
            ...
            <div className="mt-3 font-semibold text-gray-900 group-hover:text-gray-700">
              {c.title}
            </div>
            <div className="mt-1 text-sm text-gray-500">{c.description}</div>
          </Link>
        ))}
      </div>
    </section>
